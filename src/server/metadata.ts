...
export class Meta {
  public generate({
    description = 'Chat2hub offers you the best ChatGPT, OLLaMA, Gemini, Claude WebUI user experience',
    title,
    image = OG_URL,
    url,
    type = 'website',
    ...
    const siteTitle = title.includes('Chat2hub') ? title : title + ' · Chat2hub';
    return {
